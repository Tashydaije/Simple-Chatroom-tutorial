...
var chatRoomChannel = _consumer__WEBPACK_IMPORTED_MODULE_0__["default"].subscriptions.create("ChatRoomChannel", {
...
/* harmony default export */ __webpack_exports__["default"] = (chatRoomChannel);
...
$(document).on('turbolinks:load', function () {
  $("form#set_name").on('submit', function (e) {
    ...
    _channels_chat_room_channel__WEBPACK_IMPORTED_MODULE_4__["default"].announce({
      name: name,
      type: 'join'
    });
  ...
  $("form#send_message").on('submit', function (e) {
    ...
    if (message.length > 0) {
      _channels_chat_room_channel__WEBPACK_IMPORTED_MODULE_4__["default"].speak(message);
      $('#message').val('');
    }
  });
...
/******/ });
//# sourceMappingURL=application-310a6b922053541fa6a3.js.map